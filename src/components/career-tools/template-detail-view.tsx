            ...
            {product.file_url ? (
              <>
                ...
                >
                  ...
                  {downloadPending ? "Preparing download…" : "Download Template"}
                </button>
                {downloadSuccess && (
              ...
              <div className="rounded-xl border border-border bg-muted/30 p-4 text-center">
                ...
                <p className="mt-1 text-xs text-muted-foreground">This template does not currently have a file attached.</p>
              </div>
            )}
            <Link
              to="/ats-checker"
