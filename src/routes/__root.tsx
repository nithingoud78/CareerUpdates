...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:image", content: "https://careerupdates.app/careerupdates-share-2026.png" },
      ...
      { name: "twitter:image", content: "https://careerupdates.app/careerupdates-share-2026.png" },
          ...
          "@graph": [
            {
              ...
              logo: {
                "@type": "ImageObject",
                url: "https://careerupdates.app/careerupdates-share-2026.png",
                width: 1200,
                height: 630,
              },
              sameAs: [
