...
import { getCareerProductById, upsertCareerProduct, upsertBundleResources, listDmatModulesAdmin } from "@/lib/career-tools.functions";
...
export const Route = createFileRoute("/_authenticated/admin/dmat-complete/$id/edit")({
  component: EditDmatComplete,
});

function EditDmatComplete() {
    ...
    mutationFn: async (formData: ProductFormData) => {
      await save({
        data: {
          ...
          id,
          product_type: "bundle",
          resource_type: formData.resource_type || "all_modules",
  ...
  return (
    <div className="max-w-3xl space-y-6">
      <div>
        <h1 className="text-2xl font-bold">Edit dMAT Complete Pack</h1>
