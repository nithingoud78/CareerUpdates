...
export const Route = createFileRoute("/_authenticated/admin/dmat-complete/$id/")({
  component: AdminDmatCompleteOverview,
});

function AdminDmatCompleteOverview() {
  ...
  const publicUrl = `${window.location.origin}/dmat-resources/packs/${bundle.slug}`;
