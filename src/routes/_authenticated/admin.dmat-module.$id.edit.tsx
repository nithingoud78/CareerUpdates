...
export const Route = createFileRoute("/_authenticated/admin/dmat-module/$id/edit")({
  component: EditDmatModule,
});

function EditDmatModule() {
    ...
    mutationFn: (formData: ProductFormData) =>
      save({
        data: {
          ...
          resource_type: formData.resource_type || "single_module",
